...
async def init(sim):
   ...
   sim.dut.externalResetVector.value = 0
   sim.dut.timerInterrupt.value = 0
   sim.dut.externalInterrupt.value = 0
   sim.dut.softwareInterrupt.value = 0
   sim.dut.externalInterruptS.value = 0
...
async def tb(dut):
   ...
   # set up core
   sim.a2p = A2P(sim, dut.core)
   sim.a2p.traceFacUpdates = True
   sim.a2p.stopOnHang = 200
   sim.a2p.stopOnLoop = 50
   sim.allowDec = sim.a2p.allowDec
   sim.allowDec = sim.a2p.allowDec
